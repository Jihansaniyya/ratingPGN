    ...
    <div class="col-md-6 mb-2">
        <div class="card stat-card blue position-relative overflow-hidden">
            <div class="card-body py-3">
                ...
                <div class="h4 mb-0 fw-bold"><?php echo e($stats['total_forms']); ?></div>
    ...
    <div class="col-md-6 mb-2">
        <div class="card stat-card teal position-relative overflow-hidden">
            <div class="card-body py-3">
                ...
                <div class="h4 mb-0 fw-bold"><?php echo e($stats['total_petugas']); ?></div>
    ...
    <div class="col-lg-4 mb-3">
        <div class="card h-100">
            ...
            <div class="card-body py-3">
                ...
                <div class="px-2">
                    <?php $total = $stats['total_forms']; ?>
                    <div class="mb-2">
                        <div class="d-flex justify-content-between small mb-1">
                            <span><i class="fa-solid fa-face-smile me-1" style="color:#27ae60;"></i>Sangat Puas</span>
                            <span class="fw-bold"><?php echo e($stats['total_sangat_puas']); ?></span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" style="width: <?php echo e($total > 0 ? ($stats['total_sangat_puas']/$total*100) : 0); ?>%; background: #27ae60;"></div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="d-flex justify-content-between small mb-1">
                            <span><i class="fa-solid fa-face-meh me-1" style="color:#f39c12;"></i>Puas</span>
                            <span class="fw-bold"><?php echo e($stats['total_puas']); ?></span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" style="width: <?php echo e($total > 0 ? ($stats['total_puas']/$total*100) : 0); ?>%; background: #f39c12;"></div>
                        </div>
                    </div>
                    <div>
                        <div class="d-flex justify-content-between small mb-1">
                            <span><i class="fa-solid fa-face-frown me-1" style="color:#e74c3c;"></i>Tidak Puas</span>
                            <span class="fw-bold"><?php echo e($stats['total_tidak_puas']); ?></span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" style="width: <?php echo e($total > 0 ? ($stats['total_tidak_puas']/$total*100) : 0); ?>%; background: #e74c3c;"></div>
                        </div>
                    </div>
                </div>
                <?php else: ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex flex-column justify-content-end">
                        <div class="activity-item">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['survey']); ?></span>
                        </div>
                        <div class="activity-item">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['activation']); ?></span>
                        </div>
                        <div class="activity-item">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['upgrade']); ?></span>
                        </div>
                        <div class="activity-item">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['downgrade']); ?></span>
                        </div>
                        <div class="activity-item">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['troubleshoot']); ?></span>
                        </div>
                        <div class="activity-item">
                            <div class="d-flex align-items-center">
                            ...
                            <span class="fw-bold small"><?php echo e($activityStats['preventive_maintenance']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="card">
    <div class="card-header bg-white py-2 border-0 d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('forms.index')); ?>" class="btn btn-sm btn-primary btn-xs">Lihat Semua</a>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-sm mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-3 small"><?php echo e($form->customer?->customer_name ?? '-'); ?></td>
                        <td class="text-secondary small"><?php echo e($form->customer?->layanan_service ?? '-'); ?></td>
                        <td class="small">
                            <?php $activities = $form->activities; ?>
                            <?php if(count($activities) > 0): ?>
                                <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge bg-secondary me-1" style="font-size:0.7rem;"><?php echo e($activity); ?></span>
                        ...
                        <td class="text-secondary small"><?php echo e($form->created_at->format('d/m/Y')); ?></td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (assessmentEl && <?php echo e($stats['total_forms']); ?> > 0) {
            new Chart(assessmentEl, {
                type: 'doughnut',
                data: {
                    labels: ['Sangat Puas', 'Puas', 'Tidak Puas'],
                    datasets: [{
                        data: [<?php echo e($stats['total_sangat_puas']); ?>, <?php echo e($stats['total_puas']); ?>, <?php echo e($stats['total_tidak_puas']); ?>],
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(ctx) {
                                    const total = <?php echo e($stats['total_forms']); ?>;
        ...
        new Chart(document.getElementById('activityChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($activityStats['survey']); ?>,
                        <?php echo e($activityStats['activation']); ?>,
                        <?php echo e($activityStats['upgrade']); ?>,
                        <?php echo e($activityStats['downgrade']); ?>,
                        <?php echo e($activityStats['troubleshoot']); ?>,
                        <?php echo e($activityStats['preventive_maintenance']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ACER\JihanCantik\Documents\ratingPGN\resources\views/dashboard.blade.php ENDPATH**/ ?>