                ...
                <div class="mb-3">
                    ...
                    <div class="input-group password-group">
                        ...
                        <button type="button" id="togglePassword" class="input-group-text"
                            style="cursor: pointer; border: none; background: transparent; display: none; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); z-index: 10;">
...
</html><?php /**PATH C:\Users\ACER\JihanCantik\Documents\ratingPGN\resources\views/auth/login.blade.php ENDPATH**/ ?>