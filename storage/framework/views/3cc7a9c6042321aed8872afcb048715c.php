    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-user-cog me-2"></i> Form Edit Petugas
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('name', $user->name)); ?>" placeholder="Masukkan nama lengkap" required>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('email', $user->email)); ?>" placeholder="Masukkan alamat email" required>
