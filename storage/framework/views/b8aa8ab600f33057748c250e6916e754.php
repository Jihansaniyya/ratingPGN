    ...
    <nav class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="<?php echo e(route('forms.index')); ?>"
                class="<?php echo e(request()->routeIs('forms.*') || request()->routeIs('reports.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\Users\ACER\JihanCantik\Documents\ratingPGN\resources\views/layouts/app.blade.php ENDPATH**/ ?>