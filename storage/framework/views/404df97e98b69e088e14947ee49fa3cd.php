...
<div class="page-header no-print">
    ...
    <div>
        <a href="<?php echo e(route('forms.pdf', $form)); ?>" class="btn btn-outline-danger" target="_blank">
        ...
        <a href="<?php echo e(route('forms.edit', $form)); ?>" class="btn btn-outline-warning">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('forms.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ACER\JihanCantik\Documents\ratingPGN\resources\views/forms/show.blade.php ENDPATH**/ ?>