...
<?php $__env->startSection('title', 'Laporan Penilaian Pelanggan'); ?>
...
<div class="page-header">
    ...
    <div class="col-auto text-end">
                <div class="bg-white bg-opacity-10 rounded px-3 py-2">
                    <p class="text-black mb-1"><i class="fas fa-calendar-alt me-2"></i><?php echo e(now()->translatedFormat('d F Y')); ?></p>
                    <p class="text-black-50 mb-0 small">Penanggung Jawab: <?php echo e(auth()->user()->name); ?></p>
                </div>
    </div>
</div>
...
<div class="card shadow-sm mb-4 border-0">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('reports.index')); ?>" method="GET" class="row g-3 align-items-end">
            <div class="col-lg-3 col-md-6">
                ...
                <select name="assessment" class="form-select">
                    <option value="semua" <?php echo e(request('assessment') == 'semua' ? 'selected' : ''); ?>>Semua Kategori</option>
                    <option value="sangat_puas" <?php echo e(request('assessment') == 'sangat_puas' ? 'selected' : ''); ?>>Sangat Puas</option>
                    <option value="puas" <?php echo e(request('assessment') == 'puas' ? 'selected' : ''); ?>>Puas</option>
                    <option value="tidak_puas" <?php echo e(request('assessment') == 'tidak_puas' ? 'selected' : ''); ?>>Tidak Puas</option>
                </select>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="btn btn-outline-secondary" title="Atur Ulang">
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-left: 5px solid #1a5276 !important;">
            <div class="card-body text-center py-4">
                ...
                <h2 class="mb-1 fw-bold" style="color: #1a5276;"><?php echo e($stats['total']); ?></h2>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-left: 5px solid #27ae60 !important;">
            <div class="card-body text-center py-4">
                ...
                <h2 class="mb-1 fw-bold text-success"><?php echo e($stats['sangat_puas']); ?></h2>
                <p class="mb-0 text-muted">Kategori Sangat Puas</p>
                <small class="text-success"><?php echo e($stats['total'] > 0 ? number_format($stats['sangat_puas']/$stats['total']*100, 1) : 0); ?>%</small>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-left: 5px solid #f39c12 !important;">
            <div class="card-body text-center py-4">
                ...
                <h2 class="mb-1 fw-bold text-warning"><?php echo e($stats['puas']); ?></h2>
                <p class="mb-0 text-muted">Kategori Puas</p>
                <small class="text-warning"><?php echo e($stats['total'] > 0 ? number_format($stats['puas']/$stats['total']*100, 1) : 0); ?>%</small>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-left: 5px solid #e74c3c !important;">
            <div class="card-body text-center py-4">
                ...
                <h2 class="mb-1 fw-bold text-danger"><?php echo e($stats['tidak_puas']); ?></h2>
                <p class="mb-0 text-muted">Kategori Tidak Puas</p>
                <small class="text-danger"><?php echo e($stats['total'] > 0 ? number_format($stats['tidak_puas']/$stats['total']*100, 1) : 0); ?>%</small>
            </div>
        </div>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center" style="background: #f8f9fa; border-left: 4px solid #1a5276;">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('reports.print', request()->query())); ?>" target="_blank" class="btn btn-danger btn-sm">
                <i class="fas fa-file-pdf me-1"></i> Unduh Berkas PDF
            </a>
        </div>
    </div>
    <div class="card-body">
        <?php if(request('assessment') && request('assessment') !== 'semua' || request('start_date') || request('end_date')): ?>
        <div class="alert alert-info py-2 mb-3 d-flex align-items-center">
            ...
            <?php if(request('start_date')): ?>
                <span class="badge bg-secondary ms-2">Dari: <?php echo e(\Carbon\Carbon::parse(request('start_date'))->format('d/m/Y')); ?></span>
            <?php endif; ?>
            <?php if(request('end_date')): ?>
                <span class="badge bg-secondary ms-2">Sampai: <?php echo e(\Carbon\Carbon::parse(request('end_date'))->format('d/m/Y')); ?></span>
            <?php endif; ?>
        </div>
        <?php endif; ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <span class="text-nowrap"><?php echo e($form->form_date ? $form->form_date->format('d/m/Y') : '-'); ?></span>
                            </td>
                            <td>
                                <strong><?php echo e($form->customer->customer_name ?? '-'); ?></strong>
                            </td>
                            <td>
                                <small><?php echo e($form->customer->email ?? '-'); ?></small>
                            </td>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('forms.show', $form)); ?>" class="btn btn-sm btn-info" title="Lihat Detail">
        ...
        <div class="mt-3 pt-3 border-top d-flex justify-content-between align-items-center">
            <div class="text-muted">
                <i class="fas fa-database me-1"></i> Jumlah Data: <strong><?php echo e(count($forms)); ?></strong> entri
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Jihan Saniyya\ratingPGN-app\resources\views/reports/index.blade.php ENDPATH**/ ?>