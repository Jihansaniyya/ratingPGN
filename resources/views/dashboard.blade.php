...
<div class="page-header">
    ...
    <div class="text-end">
        <p class="mb-0 text-dark"><i class="fas fa-calendar-alt me-2"></i>{{ now()->translatedFormat('d F Y') }}</p>
        <small class="text-muted">Penanggung Jawab: {{ auth()->user()->name }}</small>
    </div>
</div>
        ...
        <div class="stat-card success">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="stat-value">{{ $stats['total_sangat_puas'] }}</div>
                </div>
        ...
        <div class="stat-card warning">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="stat-value">{{ $stats['total_puas'] }}</div>
                </div>
        ...
        <div class="stat-card danger">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="stat-value">{{ $stats['total_tidak_puas'] }}</div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @forelse($recentForms as $index => $form)
                            <tr>
                                <td>{{ $index + 1 }}</td>
