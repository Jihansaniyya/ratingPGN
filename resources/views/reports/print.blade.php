            ...
            <tr>
                ...
                <td style="width: 70%; vertical-align: middle; padding-left: 20px; border: none;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 10pt;">
                        <tr>
                            <th
                                style="padding: 8px 10px; border: 1px solid #000; background: #f0f0f0; text-align: left; width: 50%;">
                                Kategori</th>
                            <th
                                style="padding: 8px 10px; border: 1px solid #000; background: #f0f0f0; text-align: center; width: 25%;">
                                Jumlah</th>
                            <th
                                style="padding: 8px 10px; border: 1px solid #000; background: #f0f0f0; text-align: center; width: 25%;">
                                Persentase</th>
                        ...
                        <tr>
                            <td style="padding: 8px 10px; border: 1px solid #000;">
                                <span
                                    style="display: inline-block; width: 12px; height: 12px; background: #27ae60; margin-right: 8px; vertical-align: middle;"></span>
                                Sangat Puas
                            </td>
                        ...
                        <tr>
                            <td style="padding: 8px 10px; border: 1px solid #000;">
                                <span
                                    style="display: inline-block; width: 12px; height: 12px; background: #f39c12; margin-right: 8px; vertical-align: middle;"></span>
                                Puas
                            </td>
                            <td style="padding: 8px 10px; border: 1px solid #000; text-align: center;">
                                {{ $stats['puas'] }}</td>
                        ...
                        <tr>
                            <td style="padding: 8px 10px; border: 1px solid #000;">
                                <span
                                    style="display: inline-block; width: 12px; height: 12px; background: #e74c3c; margin-right: 8px; vertical-align: middle;"></span>
                                Tidak Puas
                            </td>
                            <td style="padding: 8px 10px; border: 1px solid #000; text-align: center;">
                                {{ $stats['tidak_puas'] }}</td>
                        ...
                        <tr>
                            <td style="padding: 8px 10px; border: 1px solid #000; background: #f0f0f0;">
